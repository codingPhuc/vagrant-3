Vagrant.configure("2") do |config|
  config.vm.define "web01" do |web01|
    ...
    web01.vm.network "forwarded_port", guest: 80, host: 8080  # Forward port 80 on the guest to port 8080 on the host
...
EOL
    ...
    web01.vm.provision "shell", name: "run_docker", inline: <<-SHELL
      ...
      docker run --name pop -p 80:3000 -d phuc2411/getting-started-todo-app  # Run the Docker container for the application
    SHELL
  end
end
